...
\Cref{sec:basic} presents a basic notion of Federated Fail-Prone System which eschews some important considerations (dealt with in~\Cref{sec:lying,sec:subjective}) but captures this main idea.
...
Instead, each process $p_i$ knows a subset $P_i$ of the participants that $p_i$ trusts to present accurate information about the rest of the system.
