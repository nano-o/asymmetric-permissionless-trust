...
% We also hope that our result will help address the problem of porting existing quorum-based algorithms to the Stellar model, and that it will enable system designer to build on the Federated Byzantine Quorum System model to devise new permissionless systems.
