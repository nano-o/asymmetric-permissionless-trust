...
Informally, Property $Q^3(\mathbb{F})$ captures the essence of the assumptions made by processes in a federated fail-prone system, i.e.\ that for every possible slice-choice graph, two processes can transitively reach a common third process despite any failures compatible with the processes' failure assumptions.
